                                    ...
                                    <div class="card-body text-left">
                                        <div class="col-12">
                                            ...
                                            <div class="payment-option-buttons">
                                                <span class="credit-card-option active" id="loadMpesaForm" type="button" onClick="loadMpesaForm()" data-processor-tab="">Mpesa</span>
                                                <span class="credit-card-option" id="loadStripeForm" type="button" onClick="loadStripeForm()" data-processor-tab="stripe">Card</span>

                                                <span class="payPal-option" id="loadPaypalForm" onClick="loadPaypalForm()" data-processor-tab="pay_pal">
                                                ...
                                                <span class="crypto-option" id="loadCryptoForm" data-processor-tab="crypto">
                                                    <a type="button" onClick="loadCryptoForm()">
...
<script>
    ...
    function loadCryptoForm() {
        ...
        <h1>Bitcoin</h1>
    `
    document.getElementById('loadCryptoForm').classList.add("active");
    document.getElementById('loadPaypalForm').classList.remove("active");
    document.getElementById('loadStripeForm').classList.remove("active");
    document.getElementById('loadMpesaForm').classList.remove("active");
    };
