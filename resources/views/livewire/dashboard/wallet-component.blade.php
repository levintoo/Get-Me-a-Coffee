                    ...
                    <div class="card order-widget">
                        <div class="card-body">
                            <div class="row heder-widget">
                                <div class="col-6"><span>Total (All time)</span>
                                    <h3 class="total-num counter">12050</h3>
                                </div>
                                <div class="col-6">
                                    <div class="text-end">
                                        <ul>
                                            <li>Earnings<span class="product-stts font-primary m-l-10">8989<i class="icon-angle-up f-12 m-l-10"></i></span></li>
                                            <li>Withdrawals<span class="product-stts font-primary m-l-10">2560<i class="icon-angle-down f-12 m-l-10"></i></span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
